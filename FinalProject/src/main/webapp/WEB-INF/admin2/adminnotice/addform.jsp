			...
			<div class="addnotice">
                    <form action="insert" method="post" enctype="multipart/form-data">
						...
						<input type="hidden" name="num_n" value="${num_n}">
           					...
           					<h2 style="color:black;"><b>공지글 등록</b></h2>
           						<br>
                    	
                    			<b style="font-size: 1.3em;color:black;margin-right: 20px;">카테고리</b>
                    			<b><select name="category" required="required" style="font-size: 1.2em;color:black;">
                    			...
                    			<b style="font-size: 1.2em;color:black;">작성자</b><input type="text" name="writer" 
                    			 class="form-control"  required="required" style="width:150px;" >
                   					<br>
                   					<b>제목</b>
