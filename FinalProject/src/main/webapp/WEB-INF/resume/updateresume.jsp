...
<table id="addcarer">
	<c:forEach var="cdto" items="${cdto }">
		<tr style="float: left;">
			...
			<td>
				<input placeholder="부서명/직책" name="department" value="${cdto.department }" style="border: none;font-size: 0.9em;">
...
<table id="addedu">
	<c:forEach var="edto" items="${edto }">
		<tr style="float: left;">
			...
			<td>
				<input placeholder="전공 및 학위" name="major" value="${edto.major }" style="border: none;font-size: 0.9em;">
				<span class="glyphicon glyphicon-remove"></span>
			</td>
		</tr>
	</c:forEach>
...
<table id="addaward">
	<c:forEach var="adto" items="${adto }">
		<tr style="float: left;">
			...
			<td>
				<input placeholder="세부사항" name="detail" value="${adto.detail }" style="border: none;font-size: 0.9em;">
				<span class="glyphicon glyphicon-remove"></span>
			</td>
		</tr>
	</c:forEach>
